              ...
              <div className="p-5">
                <div className="flex items-center">
                  <div className="flex-shrink-0">
                    <div className="w-8 h-8 bg-[#38e078] rounded-full flex items-center justify-center">
                      <svg
          ...
          <div className="mt-8 bg-white shadow rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <button
                  onClick={() => router.push('/admin/materi')}
                  className="bg-[#38e078] hover:bg-green-700 text-white px-6 py-2 rounded-md transition-colors flex items-center gap-2"
                >
